            ...
            <div class="container">
                <div class="row">
                    <div class="course text-center d-flex justify-content-between align-items-center my-2">
                        <div class="">
                            <!-- back  -->
                            <a href="session_exp.php" class="btn btn-warning shadow"><i class="bi bi-arrow-left"></i> Back</a>
                        </div>
                        ...
                        <div class="table-responsive w-100 p-2 my-2">
                            <table
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td class="text-start"><?php echo $row['fourth_sub_name']; ?> </td>
                                        <td><?php echo $row['fourth_sub_code']; ?></td>
                                        <td><?php echo $row['max_mark']; ?></td>
                                        <td><?php echo $row['fourth_sub_mark']; ?></td>
                                        <td>
                                        <?php
                                            if ($row['fourth_sub_mark'] == 25) {
                                                echo "A++";
                                            } elseif ($row['fourth_sub_mark'] >= 23) {
                                                echo "A+";
                                            } elseif ($row['fourth_sub_mark'] >= 20) {
                                                echo "A";
                                            } elseif ($row['fourth_sub_mark'] >= 10) {
                                                echo "B";
                                            } else {
                                                echo "C";
                                            }
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td class="text-start"><?php echo $row['fifth_sub_name']; ?></td>
                                        <td><?php echo $row['fifth_sub_code']; ?></td>
                                        <td><?php echo $row['max_mark']; ?></td>
                                        <td><?php echo $row['fifth_sub_mark']; ?></td>
                                        <td>
                                        <?php
                                            if ($row['fifth_sub_mark'] == 25) {
                                                echo "A++";
                                            } elseif ($row['fifth_sub_mark'] >= 23) {
                                                echo "A+";
                                            } elseif ($row['fifth_sub_mark'] >= 20) {
                                                echo "A";
                                            } elseif ($row['fifth_sub_mark'] >= 10) {
                                                echo "B";
                                            } else {
                                                echo "C";
                                            }
                                    ...
                                    <tr>
                                        <td>6</td>
                                        <td class="text-start"><?php echo $row['sixth_sub_name']; ?></td>
                                        <td><?php echo $row['sixth_sub_code']; ?></td>
                                        <td><?php echo $row['max_mark']; ?></td>
                                        <td><?php echo $row['sixth_sub_mark']; ?></td>
                                        <td>
                                        <?php
                                            if ($row['sixth_sub_mark'] == 25) {
                                                echo "A++";
                                            } elseif ($row['sixth_sub_mark'] >= 23) {
                                                echo "A+";
                                            } elseif ($row['sixth_sub_mark'] >= 20) {
                                                echo "A";
                                            } elseif ($row['sixth_sub_mark'] >= 10) {
                                                echo "B";
                                            } else {
                                                echo "C";
                                            }
                            ...
                            <table class="table table-danger table-striped table-hover table-bordered text-center w-100 shadow">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $first_sub_mark = $row['first_sub_mark'];
                                            $second_sub_mark = $row['second_sub_mark'];
                                            $third_sub_mark = $row['third_sub_mark'];
                                            $fourth_sub_mark = $row['fourth_sub_mark'];
                                            $fifth_sub_mark = $row['fifth_sub_mark'];
                                            $sixth_sub_mark = $row['sixth_sub_mark'];

                                            $totalMarks = $first_sub_mark + $second_sub_mark + $third_sub_mark + $fourth_sub_mark + $fifth_sub_mark + $sixth_sub_mark;
                                        ...
                                        <td>
                                            <?php
                                            $totalMarks = $first_sub_mark + $second_sub_mark + $third_sub_mark + $fourth_sub_mark + $fifth_sub_mark + $sixth_sub_mark;
                                            $total_max_mark = $row['total_max_mark'];
                                            $percentage = ($totalMarks / $total_max_mark) * 100;
                                            echo $percentage;
                                            ?>
                                        </td>
                                        <td>
