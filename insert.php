...
$sql = "INSERT INTO first_ct (name, roll_no, father_name, mother_name, dob, gender, enroll_no, college_name, first_sub_name, first_sub_code, first_sub_mark, second_sub_name, second_sub_code, second_sub_mark, third_sub_name, third_sub_code, third_sub_mark, fourth_sub_name, fourth_sub_code, fourth_sub_mark, fifth_sub_name, fifth_sub_code, fifth_sub_mark, sixth_sub_name, sixth_sub_code, sixth_sub_mark, total_max_mark, total_obt_mark, total_sub, percentage, result, division) 
VALUES ('$name', '$roll_no', '$father_name', '$mother_name', '$dob', '$gender', '$enroll_no', '$college_name', '$first_sub_name', '$first_sub_code', '$first_sub_mark', '$second_sub_name', '$second_sub_code', '$second_sub_mark', '$third_sub_name', '$third_sub_code', '$third_sub_mark', '$fourth_sub_name', '$fourth_sub_code', '$fourth_sub_mark', '$fifth_sub_name', '$fifth_sub_code', '$fifth_sub_mark', '$sixth_sub_name', '$sixth_sub_code', '$sixth_sub_mark', '$total_max_mark', '$total_obt_mark', '$total_sub', '$percentage', '$result', '$division')";
